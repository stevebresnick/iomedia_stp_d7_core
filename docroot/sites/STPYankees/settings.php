...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iomediastp1_dev_STPYankees.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iomediastp1_dev_STPYankees.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/iomediastp1/STPYankees-settings.inc');
}